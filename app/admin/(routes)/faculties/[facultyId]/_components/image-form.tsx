...
export const ImageForm = ({ initialData, facultyId }: ImageFormProps) => {
  ...
  const onSubmit = async (fileUrl: string) => {
    ...
    try {
      await axios.patch(`/api/faculties/${facultyId}`, imageUrl);
      ...
      toast.error("Something went wrong while updating faculty image", {
        position: "top-center",
        autoClose: 5000,
      });
    }
