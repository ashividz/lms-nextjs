...
export const ImageForm = ({ initialData, testimonialId }: ImageFormProps) => {
  ...
  const onSubmit = async (fileUrl: string) => {
    ...
    try {
      await axios.patch(`/api/testimonials/${testimonialId}`, imageUrl);
      ...
      toast.error("Something went wrong while updating testimonial image", {
        position: "top-center",
        autoClose: 5000,
      });
    }
